...
namespace Week10Assessment.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(Week10AssessmentContext context)
        {
            _context = context;
        }
        ...
        {
            var week10AssessmentContext = _context.Employee.Include(e => e.Department);
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FullName,Email,DepartmentId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FullName,Email,DepartmentId")] Employee employee)
        {
