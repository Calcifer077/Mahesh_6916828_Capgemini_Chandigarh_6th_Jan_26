...
namespace UniversityMS.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(UniversityMSContext context)
        {
            _context = context;
        }
        ...
        {
            var universityMSContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Set<Student>(), "StudentId", "Email");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,StudentId,CourseId,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Set<Student>(), "StudentId", "Email", enrollment.StudentId);
            return View(enrollment);
        }
